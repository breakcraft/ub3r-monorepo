    ...
    private void method175(int i, WorldController worldController, Class11 class11, int j, int k, int l, int i1, int j1) {
        ...
        if (j == 10 || j == 11) {
            ...
            if (obj1 != null) {
                ...
                int l4;
                if (j1 == 1 || j1 == 3) {
                    j4 = ObjectDef.anInt761;
                    l4 = class46.anInt744;
                } else {
                    j4 = class46.anInt744;
                    l4 = ObjectDef.anInt761;
                }
            ...
            if (class46.aBoolean767 && class11 != null)
                class11.method212(class46.aBoolean757, class46.anInt744, ObjectDef.anInt761, l, i, j1);
            return;
        }
        if (j >= 12) {
            Object obj2;
            ...
            do {
                ...
                do {
                    ...
                    if (j3 == i && i3 >= i1 && i3 < i1 + 8 && l2 >= k && l2 < k + 8) {
                        ...
                        int j4 = j + Class4.method157(j1, ObjectDef.anInt761, i3 & 7, l2 & 7, class46.anInt744);
                        int k4 = k1 + Class4.method158(l2 & 7, ObjectDef.anInt761, j1, class46.anInt744, i3 & 7);
    ...
    public static void method188(WorldController worldController, int i, int j, int k, int l, Class11 class11, int ai[][][], int i1, int j1, int k1) {
        ...
        if (k == 10 || k == 11) {
            ...
            if (obj1 != null) {
                ...
                int i5;
                if (i == 1 || i == 3) {
                    k4 = ObjectDef.anInt761;
                    i5 = class46.anInt744;
                } else {
                    k4 = class46.anInt744;
                    i5 = ObjectDef.anInt761;
                }
                worldController.method284(i3, byte1, l2, i5, ((Animable) (obj1)), k4, k1, j5, j, i1);
            }
            if (class46.aBoolean767)
                class11.method212(class46.aBoolean757, class46.anInt744, ObjectDef.anInt761, i1, j, i);
            return;
        }
        if (k >= 12) {
            Object obj2;
